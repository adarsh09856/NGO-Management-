...
# Usage on VPS: bash scripts/deploy-aapanel.sh  OR  bash deploy.sh
# ==============================================================================
set -e

# Always resolve to project root directory
...
if command -v git &> /dev/null; then
    ...
    git pull origin main || {
        echo "⚠️ Warning: 'git pull origin main' encountered an issue or working directory has local changes."
