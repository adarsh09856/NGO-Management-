...
export default function PagesDirectory() {
  const pages = [
    ...
    },
    {
      ...
      studioUrl: '/admin/prayer-requests',
      icon: Flame,
      color: 'amber',
      sectionsCount: 2,
      sections: ['Prayers Header', 'Puja Dedication Desk'],
      status: 'Live & Editable',
    },
    {
      id: 'shedra',
      ...
      tibetan: 'བཤད་གྲྭ།',
      route: '/shedra',
      studioUrl: '/admin/monks',
      icon: GraduationCap,
      color: 'indigo',
      sectionsCount: 3,
      sections: ['Monastic Hero', '5 Great Shastras', 'Monk Scholar Registry'],
      status: 'Live & Editable',
    },
    {
      id: 'learning',
    ...
    },
    {
      ...
      tibetan: 'འབྲེལ་གཏུགས།',
      route: '/contact',
      studioUrl: '/admin/site-settings#contact',
      icon: Phone,
      color: 'slate',
      sectionsCount: 2,
      sections: ['Monastery Seat Info', 'CRM Inquiry Desk'],
      status: 'Live & Editable',
    },
  ];
