...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#1F0408] via-[#2C060D] to-[#120205] text-white">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="w-16 h-16 rounded-full bg-[#4A0E17] border-2 border-[#D4AF37] flex items-center justify-center mx-auto shadow-2xl">
          ...
          <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-[#4A0E17]/80 border border-[#D4AF37]/40 text-[11px] font-bold text-[#D4AF37] uppercase tracking-wider">
        ...
        {/* Login Card */}
        <div className="bg-[#2C060D]/90 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-[#D4AF37]/30 shadow-[0_20px_50px_rgba(0,0,0,0.6)] space-y-5">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#7E1929] hover:bg-[#8B1E2F] text-white py-2.5 rounded font-bold text-xs uppercase tracking-wider flex items-center justify-center space-x-1.5 shadow-lg border border-[#D4AF37]/40 transition-all"
            >
