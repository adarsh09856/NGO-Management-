      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="monastery-card p-6 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            <div className="w-10 h-10 rounded-full bg-[#FDF6E2] text-[#4A0E17] flex items-center justify-center">
              <Heart className="w-5 h-5" />
            </div>
            <h3 className="font-serif-brand font-bold text-base text-[#4A0E17]">Donation & Tax Receipt Register</h3>
          ...
          <button
            ...
            className="w-full bg-[#4A0E17] hover:bg-[#5A121E] text-white py-2.5 rounded font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow"
          >
        ...
        <div className="monastery-card p-6 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <h3 className="font-serif-brand font-bold text-base text-[#4A0E17]">Accounts & General Ledger</h3>
        ...
        <div className="monastery-card p-6 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <h3 className="font-serif-brand font-bold text-base text-[#4A0E17]">Store Inventory Valuation</h3>
        ...
        <div className="monastery-card p-6 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <h3 className="font-serif-brand font-bold text-base text-[#4A0E17]">Shedra Academic & Monk Roster</h3>
        ...
        <div className="monastery-card p-6 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <h3 className="font-serif-brand font-bold text-base text-[#4A0E17]">HRM & Monthly Payroll Slips</h3>
